                            ...
                            <div class="mb3">
                                <div class="sidebar-profile">
                                    <div class="avatar-container mb-2">
                                        <div class="profile-image">
                                            <div class="avatar-view mt-card-avatar mt-card-avatar-circle"
                                                ...
                                                <img src="{{ asset('public/assets/vendor/core/core/base/images/placeholder.png')}}" alt="Zaeem Asif"
                                                    class="br-100" style="width: 150px;">
                                    ...
                                    <div class="f6 mb3 light-gray-text">
                                        <i class="fas fa-envelope mr2"></i><a href="#"
                                            class="gray-text">{{ Auth::user()->email ?? '' }}</a>
                                    </div>
                                    <div class="mb3">
                                        <div class="light-gray-text mb2">
                                            <i class="fas fa-calendar-alt mr2"></i>Joined {{ Auth::user()->created_at->format('M-d-Y') ? : '' }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="avatar-body">
                                        ...
                                        <div class="avatar-upload">
                                            ...
                                            <input type="hidden" name="_token"
                                                value="Bxl4NQiRvx3EJiWo4s1Ms4xR3yKXgOJixJGJ5n9d"> <label
                                                for="avatarInput">New image</label>
